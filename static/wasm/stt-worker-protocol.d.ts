...
export type SttLineEventName = 'onLineStarted' | 'onLineUpdated' | 'onLineTextChanged' | 'onLineSpeakersChanged' | 'onLineCompleted';
...
//# sourceMappingURL=stt-worker-protocol.d.ts.map